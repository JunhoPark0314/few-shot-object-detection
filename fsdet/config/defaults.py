...
_CC.MEMORY.NUM_INSTANCE = 2000

_CC.DATASETS.CONDITION = ()

_CC.MODEL.ENCODER = CN()
_CC.MODEL.ENCODER.USE_DELTAS = 1.0
_CC.MODEL.ENCODER.USE_SCALE = 1.0
_CC.MODEL.ENCODER.NOK = 8
_CC.MODEL.ENCODER.ALPHA_DIM = 8
_CC.MODEL.ENCODER.REDUCE = 8
_CC.MODEL.ENCODER.TEMPERATURE = 4
_CC.MODEL.ENCODER.CONT_LOSS = True

...
__all__ = ["BankRCNN", "BankProposalNetwork"]


@META_ARCH_REGISTRY.register()
class BankRCNN(nn.Module):
    """
    ...
    def __init__(self, cfg, prepare_feature=False):
        super().__init__()
        ...
        self.to(self.device)
        self.prepare_feature = prepare_feature

    def forward(self, batched_inputs, support_feature=None):
        """
        Args:
        ...
        if self.prepare_feature:
            feature_dict = {
                "proposal": proposal_feature_dict,
                "roi": roi_feature_dict
            }
        else:
            feature_dict = {}
